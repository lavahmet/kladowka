...
public class AppUserServiceImpl implements AppUserService {
    ...
    public String registerUser(AppUser appUser) {
        ...
        return "Введите пожплуйста email";
    }
    ...
    public String setEmail(AppUser appUser, String email) {
        try {
            ...
            return "Введите корректный email, Для отмены команды ввелите /cancel";
        }
        ...
        if (optional.isEmpty()) {
            ...
            return "Этот email уже используеься. Введите корректный email"
                    + "Для отмены команды ввелите /cancel";
        }
